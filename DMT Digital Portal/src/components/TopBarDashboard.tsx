    ...
    <div className={`flex h-16 items-center justify-between border-b px-6 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className={`absolute right-0 top-full mt-2 w-80 rounded-lg shadow-lg ${
        ...
        <div className="relative">
          ...
          >
            ...
            />
            <span className="text-sm font-medium">Mohomed Paramee</span>
            <User className="h-4 w-4 opacity-70" />
          </button>

          {showProfile && (
            <div className={`absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg ${
              isDarkMode ? 'bg-gray-800' : 'bg-white'
            }`}>
              <div className="p-2">
